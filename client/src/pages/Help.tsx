...
const HELP_TOPICS: HelpTopic[] = [
  ...
  },
  {
    ...
    content: {
      ...
      steps: [
        ...
        'Click "Add New Host" to register an organization',
        'Enter host name, contact info, location, and collection details',
        'Browse the host directory to view all registered hosts',
        'Search and filter hosts by status or location',
        'Click on a host to view their profile and collection history',
      ],
      tips: [
        'Keep contact information up-to-date for effective communication',
        'Review host profiles before scheduling events',
        'Track collection history to identify top-performing hosts',
        'Use the directory search to quickly find specific hosts',
      ],
    },
  },
  {
    ...
    content: {
      ...
      steps: [
        ...
        'Click "Create New Reminder" to set up a reminder',
  ...
  },
  {
    ...
    content: {
      summary: 'Your availability calendar helps coordinators know when you can volunteer.',
      steps: [
        'Navigate to "My Availability" from the main menu',
        'View your availability calendar (green = available, red = unavailable)',
        'Click on any date to update your availability',
        'Set specific time ranges for partial day availability',
        'Create recurring patterns for regular availability',
        'Save your availability to share with the team',
      ],
      tips: [
        'Update availability regularly to help with scheduling',
        'Use recurring patterns to save time',
