          ...
          <table className="w-full border-collapse table-fixed">
            <thead>
              <tr className="border-b-2 border-[#236383]/10 bg-gradient-to-r from-[#236383]/5 to-[#47B3CB]/5">
                <th className="text-left p-3 lg:p-4 premium-text-body-sm font-semibold text-[#236383] w-[110px]">Date</th>
                <th className="text-left p-3 lg:p-4 premium-text-body-sm font-semibold text-[#236383] w-[140px]">Host</th>
                <th className="text-left p-3 lg:p-4 premium-text-body-sm font-semibold text-[#236383] w-[85px]">Indiv.</th>
                <th className="text-left p-3 lg:p-4 premium-text-body-sm font-semibold text-[#236383] w-[170px]">Groups</th>
                <th className="text-left p-3 lg:p-4 premium-text-body-sm font-semibold text-[#236383] w-[75px]">Total</th>
                <th className="text-left p-3 lg:p-4 premium-text-body-sm font-semibold text-[#236383]">Submitted</th>
                <th className="text-right p-3 lg:p-4 premium-text-body-sm font-semibold text-[#236383] w-[90px]">Actions</th>
              </tr>
            </thead>
            <tbody>
              {collections.map((collection) => {
                ...
                return (
                  ...
                  >
                    <td className="p-3 lg:p-4 overflow-hidden">
                    ...
                    <td className="p-3 lg:p-4 overflow-hidden">
                      <div className="flex items-center min-w-0">
                        <span className="premium-badge-info text-xs whitespace-nowrap">
                      ...
                      {groupCollections.length > 0 ? (
                        <div className="space-y-1 min-w-0">
                          {groupCollections.map((group: any, idx: number) => (
                            <div key={idx} className="text-xs flex items-center gap-1.5 min-w-0">
                              <span className="font-semibold text-[#236383] truncate flex-1 min-w-0">{group.groupName}:</span>
                              <span className="premium-badge-success text-xs flex-shrink-0 whitespace-nowrap">{group.sandwichCount}</span>
                            </div>
                          ))}
                        </div>
                      ) : (
                    ...
                    <td className="p-3 lg:p-4 overflow-hidden">
                      <div className="flex items-center min-w-0">
                        <span className="inline-flex items-center gap-1 px-2.5 py-1 text-sm font-bold rounded-full bg-gradient-to-r from-[#236383] to-[#007E8C] text-white shadow-sm whitespace-nowrap">
                          {total}
                        </span>
                      </div>
                    </td>
                    <td className="p-3 lg:p-4 overflow-hidden">
                      <div className="min-w-0 space-y-0.5">
                        <div className="flex items-center gap-1.5 min-w-0">
                          <User className="h-3 w-3 text-[#007E8C] flex-shrink-0" />
                          <span className="text-gray-800 text-xs font-medium truncate">{(collection as any).createdByName || 'Unknown'}</span>
                        </div>
                        <div className="text-[10px] text-gray-500 truncate ml-4">
                          {(() => {
                    ...
                    <td className="p-3 lg:p-4 overflow-hidden">
                      <div className="flex justify-end gap-1.5">
                        <Button
                          ...
                          disabled={isUpdating}
                          className="h-8 w-8 p-0 hover:bg-[#007E8C]/10 hover:text-[#007E8C] transition-colors flex-shrink-0"
                        >
                        ...
                        <Button
                          ...
                          disabled={isDeleting}
                          className="h-8 w-8 p-0 text-[#A31C41] hover:text-[#8B1736] hover:bg-[#A31C41]/10 transition-colors flex-shrink-0"
                        >
