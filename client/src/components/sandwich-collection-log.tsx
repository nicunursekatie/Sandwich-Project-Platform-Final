              ...
              >
                ...
                <div className="space-y-3 sm:space-y-0 sm:grid sm:grid-cols-2 sm:gap-4">
                  ...
                  <div className="bg-slate-50 rounded-lg p-3">
                    ...
                    {(collection.individualDeli || collection.individualPbj) && (
                      <div className="mt-2 flex gap-2 text-xs">
                        {collection.individualDeli > 0 && (
                          <span className="bg-white px-2 py-1 rounded text-slate-600">
                            <span className="font-medium text-slate-700">{collection.individualDeli}</span> Deli
                          </span>
                        )}
                        {collection.individualPbj > 0 && (
                          <span className="bg-white px-2 py-1 rounded text-slate-600">
                            <span className="font-medium text-slate-700">{collection.individualPbj}</span> PBJ
                          </span>
                        )}
                      </div>
                    )}
