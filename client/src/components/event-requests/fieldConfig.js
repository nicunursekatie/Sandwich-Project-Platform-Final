...
exports.DEFAULT_FORM_DATA = exports.DATE_FIELDS = exports.UI_ONLY_FIELDS = exports.FIELD_MAPPINGS = void 0;
exports.getServerFieldName = getServerFieldName;
exports.getClientFieldName = getClientFieldName;
exports.isUiOnlyField = isUiOnlyField;
/**
 ...
 */
function getServerFieldName(clientFieldName) {
    return exports.FIELD_MAPPINGS.clientToServer[clientFieldName] || clientFieldName;
}
/**
 * Get the client field name for a server field name.
 */
function getClientFieldName(serverFieldName) {
    return exports.FIELD_MAPPINGS.serverToClient[serverFieldName] || serverFieldName;
}
/**
 * Check if a field is UI-only (not sent to server).
 */
function isUiOnlyField(fieldName) {
    return exports.UI_ONLY_FIELDS.includes(fieldName);
}
