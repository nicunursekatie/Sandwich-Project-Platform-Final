      ...
      <Tooltip open={isVisible} onOpenChange={setIsVisible}>
        ...
        >
          ...
          `}>
            ...
            {/* Actions */}
            {(content.actions || content.learnMoreUrl || content.dismissible) && (
...
export function InfoTooltip({ title, description, children, ...props }: {
  title: string;
  description: string;
  children: React.ReactNode;
...
export function TipTooltip({ title, description, children, ...props }: {
  title: string;
  description: string;
  children: React.ReactNode;
} & Partial<ContextualTooltipProps>) {
