...
const QUICK_TOOLS: QuickTool[] = [
  {
    ...
    icon: Calculator,
    url: 'https://docs.google.com/spreadsheets/d/1-ABC123/edit', // Placeholder - actual URL from app config
    color: 'bg-blue-500',
    category: 'calculator',
  },
  {
  ...
  {
    id: 'volunteer-flyer',
    name: 'Volunteer Flyer',
    description: 'Recruitment flyer for new volunteers',
    icon: FileImage,
    url: 'https://drive.google.com/file/d/1-MNO345/view',
    color: 'bg-pink-500',
    category: 'flyer',
  },
  {
    id: 'host-flyer',
    name: 'Host Flyer',
    description: 'Information flyer for potential hosts',
    icon: FileImage,
    url: 'https://drive.google.com/file/d/1-PQR678/view',
    color: 'bg-teal-500',
    category: 'flyer',
  },
];
