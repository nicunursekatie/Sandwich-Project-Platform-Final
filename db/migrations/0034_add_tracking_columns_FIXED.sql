-- Migration: 0034_add_tracking_columns_FIXED.sql
-- Purpose: Add lifecycle tracking columns to existing tables
-- Date: 2025-11-15
-- Breaking: No (additive only)
-- FIXED: Changed owner_id from INTEGER to TEXT to match users.id type
...
-- FIXED: Changed from INTEGER to TEXT to match users.id type
ALTER TABLE projects
  ADD COLUMN IF NOT EXISTS owner_id TEXT,  -- CHANGED FROM INTEGER TO TEXT
