...
- **Coolers Page Navigation**: The Coolers page (`/cooler-tracking`) is a standalone page accessed through the main dashboard navigation. It was mistakenly embedded as a tab in the User Management dialog and has been corrected to exist only as its own page. The permission `NAV_COOLER_TRACKING` controls access to the standalone page.
