...
Peak Year Data Analysis: Database analysis (Oct 30, 2025) confirms 2022 was the organization's peak year with 442,335 total sandwiches across 493 collections. Annual totals (sorted by volume): 2024 (503,851), 2023 (463,764), 2022 (442,335), 2025 (361,745 incomplete year), 2021 (281,395), 2020 (44,958). Fixed hardcoded "Nov 15, 2023" peak week date on dashboard to display actual calculated peak week from real data (client/src/components/dashboard-overview.tsx:576).
2023 Data Import: Successfully imported 462 collection records from production database (Oct 30, 2025) totaling 463,764 sandwiches. Import performed via direct SQL INSERT statements using generated batch files (/tmp/2023-batch-*.sql). Development database now has complete historical data from 2020-2025.
