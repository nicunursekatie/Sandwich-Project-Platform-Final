...
Complete category list: corp, small_medium_corp, large_corp, church_faith, religious, nonprofit, government, hospital, political, school, neighborhood, club, and other. **Locations**: `shared/schema.ts`, `client/src/components/organizations-catalog.tsx`.
