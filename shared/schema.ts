...
export const eventRequests = pgTable("event_requests", {
  ...
  assignedDriverIds: jsonb("assigned_driver_ids").$type<string[]>().default([]), // Array of user IDs assigned as drivers
  assignedSpeakerIds: jsonb("assigned_speaker_ids").$type<string[]>().default([]), // Array of user IDs assigned as speakers
