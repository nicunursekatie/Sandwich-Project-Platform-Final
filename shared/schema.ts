...
export const eventRequests = pgTable(
  'event_requests',
  {
    ...
    organizationCategory: varchar('organization_category'), // 'corp', 'small_medium_corp', 'large_corp', 'church_faith', 'religious', 'nonprofit', 'government', 'school', 'neighborhood', 'club', 'other'
