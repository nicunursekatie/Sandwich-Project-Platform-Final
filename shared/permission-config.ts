...
export function getPermissionDescription(permission: string): string {
  const descriptions: Record<string, string> = {
    ...
    [PERMISSIONS.NAV_VOLUNTEER_HUB]: 'Open the Volunteer Hub page (includes signing yourself up for events)',
    [PERMISSIONS.EVENT_REQUESTS_SELF_SIGNUP]: 'Sign yourself up for Volunteer Hub event roles. Automatically included when Open Volunteer Hub is enabled.',
    [PERMISSIONS.EVENT_REQUESTS_ASSIGN_OTHERS]: 'Assign another person to Volunteer Hub event roles',
    [PERMISSIONS.VOLUNTEER_SIGNUP_APPROVE]: 'See, approve, decline, change, or remove Volunteer Hub signups',
    [PERMISSIONS.DRIVER_SIGNUP_APPROVE]: 'Approve driver role signups and assign people as drivers',
