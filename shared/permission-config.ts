...
export const PERMISSION_GROUPS = {
  ...
  COOLER_TRACKING: {
    ...
    permissions: [
      ...
      PERMISSIONS.COOLERS_REPORT_OWN,
      PERMISSIONS.COOLERS_EDIT_OWN,
      PERMISSIONS.COOLERS_VIEW_ALL,
      PERMISSIONS.COOLERS_EDIT_ALL,
      PERMISSIONS.COOLERS_DELETE_OWN,
      PERMISSIONS.COOLERS_DELETE_ALL,
      PERMISSIONS.COOLERS_MANAGE_TYPES,
    ],
  },
  VOLUNTEER_CALENDAR: {
