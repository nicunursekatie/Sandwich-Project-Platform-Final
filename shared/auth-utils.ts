...
export const PERMISSIONS = {
  ...
  COOLERS_VIEW: 'COOLERS_VIEW', // View cooler inventory
  COOLERS_REPORT_OWN: 'COOLERS_REPORT_OWN', // Report own cooler inventory
  COOLERS_EDIT_OWN: 'COOLERS_EDIT_OWN', // Edit own cooler reports
  COOLERS_VIEW_ALL: 'COOLERS_VIEW_ALL', // View all users' cooler inventory
  COOLERS_EDIT_ALL: 'COOLERS_EDIT_ALL', // Edit any cooler report
  COOLERS_DELETE_OWN: 'COOLERS_DELETE_OWN', // Delete own cooler reports
  COOLERS_DELETE_ALL: 'COOLERS_DELETE_ALL', // Delete any cooler report
  COOLERS_MANAGE_TYPES: 'COOLERS_MANAGE_TYPES', // Manage cooler types (admin)
...
export const PERMISSION_DEPENDENCIES: Record<string, string[]> = {
  ...
  [PERMISSIONS.NAV_COOLER_TRACKING]: [PERMISSIONS.COOLERS_VIEW, PERMISSIONS.COOLERS_REPORT_OWN],
  ...
  // NAV_IMPORTANT_DOCUMENTS, NAV_IMPORTANT_LINKS, NAV_HELP, and NAV_WISHLIST don't have separate functional
