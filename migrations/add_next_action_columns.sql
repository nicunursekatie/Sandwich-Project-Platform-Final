...
-- Note: Combined into single DO block for Neon serverless compatibility (can't execute multiple commands)
DO $$
BEGIN
    IF NOT EXISTS (
        SELECT 1 
        ...
        ALTER TABLE event_requests ADD COLUMN next_action TEXT;
    ...
    IF NOT EXISTS (
        ...
        ALTER TABLE event_requests ADD COLUMN next_action_updated_at TIMESTAMP;
